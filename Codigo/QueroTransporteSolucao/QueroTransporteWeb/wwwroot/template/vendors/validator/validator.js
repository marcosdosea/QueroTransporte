...
var validator = (function ($) {
    ...
    */
    message = {
        ...
        min: 'Dado muito curto!',
        max: 'Dado muito longo!',
        number_min: 'Não atende ao minimo!',
        number_max: 'Excedeu o limite!',
        url: 'URL invalida!',
        number: 'Não é um numero!',
        email: 'Endereço de email invalido!',
        email_repeat: 'Emails diferentes!',
        password_repeat: 'Senhas diferentes!',
        repeat: 'Itens diferentes!',
        complete: 'Campo incompleto!',
        select: 'Por favor selecione uma opcao!'
    };
